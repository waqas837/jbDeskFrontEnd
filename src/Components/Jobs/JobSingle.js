...
const SingleJob = () => {
  ...
  const getJobSingle = async () => {
    try {
      setloading(true);
      const { data } = await axios.get(`${url}/getsinglejobbyId/${jobId}`);
          ...
          <Grid item sm={12} md={4}>
            ...
            >
              <div className={classes.ProfileSection}>
                <h3 className={classes.Section1Header}>Jobs Overview</h3>
              </div>
              <Box
                display="flex"
              ...
              >
                ...
                <List>
                  ...
                  <ListItem className={classes.ListItem}>
                    ...
                    <ListItemText primary="Salary :" secondary={state.salary} />
                  </ListItem>
                  <ListItem className={classes.ListItem}>
                    <ListItemAvatar>
          ...
          <Grid item sm={12} md={8}>
            <Grid item xs={12}>
              ...
              >
                ...
                >
                  <h3 className={classes.ParagraphHeader}>Job Description</h3>
                ...
                >
                  <h3 className={classes.ParagraphHeader}>Responsibilities</h3>
                  <p>{state.jobresp}</p>
                ...
                >
                  <h3 className={classes.ParagraphHeader}>How to Apply</h3>
                  <p>{state.howtoapply}</p>
                </Box>
                ...
                >
                  <h3 className={classes.ParagraphHeader}>Location</h3>
                  {state.location}
                </Box>
                <Divider />
                <Box
